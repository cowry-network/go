...
func build(pkg, dest, version, buildOS, buildArch string) {
	...
	timeFlag := fmt.Sprintf("-X github.com/cowry-network/go/support/app.buildTime=%s", buildTime)
	versionFlag := fmt.Sprintf("-X github.com/cowry-network/go/support/app.version=%s", version)
...
func repoName() string {
	...
	return "github.com/cowry-network/go"
