...
Download the binary from [the release page](https://github.com/cowry-network/go/releases/tag/bifrost-v0.0.2) and use it with it's [Bifrost JS SDK](https://github.com/stellar/bifrost-js-sdk).
...
* `stellar`
  ...
  * `horizon` - URL to [horizon](https://github.com/cowry-network/go/tree/master/services/horizon) server
