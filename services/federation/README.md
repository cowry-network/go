...
[Prebuilt binaries](https://github.com/cowry-network/go/releases) of the federation server are available on the [releases page](https://github.com/cowry-network/go/releases).
...
```
go get -u github.com/cowry-network/go/services/federation
```
