...
import (
	...
	"github.com/cowry-network/go/protocols/horizon/effects"
...
func TestEffectActions_Index(t *testing.T) {
	...
	t.Run("omnibus test", func(t *testing.T) {
		...
		// test streaming, regression for https://github.com/cowry-network/go/services/horizon/internal/issues/147
